...
class clusterSettingDialog(wx.Dialog):
    ...
    def __init__(
        self, cluster_address, tasks_per_node, work_dir, setup_script, run_command
    ):
        """Constructor"""
        super().__init__(None, title="Login", size=(420, 540))
        ...
        cluster_address_label.SetToolTip(
            wx.ToolTip(
        ...
        tasks_per_node_label.SetToolTip(
            wx.ToolTip(
...
class LoginDialog(wx.Dialog):
    ...
    def __init__(self, username=""):
        ...
        self.username = wx.TextCtrl(
            self.panel, value=username, size=(160, -1), style=wx.TE_PROCESS_ENTER
        )
        ...
        self.password = wx.TextCtrl(
            self.panel, size=(160, -1), style=wx.TE_PASSWORD | wx.TE_PROCESS_ENTER
        )
